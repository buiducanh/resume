...
\section{Projects}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {ActivityTracker}{Amherst, MA}
      {CS390MB Mobile Health Sensing \& Monitoring}{Fall 2015}

      \resumeItemListStart
        \resumeItem{}{Developed an Android app to track health-related metrics}
        \resumeItem{}{Implemented algorithms to track footsteps, classify activities, and calculate heart rate}
      \resumeItemListEnd
...
\section{Skills}
  \resumeItemListStart
    \resumeItem{Proficient}{: Java, Python, Javascript, Shell, Hack, React}
    \resumeItem{Familiar}{: C++, Tensorflow, Android, HTML, CSS}
  \resumeItemListEnd
